...
export default function Project(){
 ...
 const projects = useMemo(
  ...
  return(
  <section id="project" ref={sceneRef} className=" retlative text-white" style={{
    ...
    <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
      ...
      <div className={`relative w-full flex-1 flex items-center justify-center ${
        ...
        {projects.map((project,idx)=>(
          ...
          className={`absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 transition-all duration-500 ${
      ...
      <div className={`absolute ${
        ...
        className="inline-block px-6 py-3 font-smibo rounded-lg bg-white text-black hover:bg-gray-200 transition-all"
